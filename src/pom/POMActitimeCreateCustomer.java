...
public class POMActitimeCreateCustomer implements AutoConstant
{
	...
	{
		customerNameTextField.sendKeys(ExcelLibrary.getcellvalue(excelpath_Actitime, sheetName_CustomerName, 1, 0));
